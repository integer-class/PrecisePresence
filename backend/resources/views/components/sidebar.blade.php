<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <!-- <a href="index.html">Stislaa</a> -->
            <img src="{{ asset('img/logo.png') }}" alt="logo" width="100" class="img-responsive">
        </div>
        <div class="sidebar-brand sidebar-brand-sm">
            <!-- <a href="index.html">St</a> -->
            <img src="{{ asset('img/logo.png') }}" alt="logo" width="65" class="img-responsive">
        </div>
        <ul class="sidebar-menu">
            <li class="menu-header">Dashboard</li>
            <li class="{{ $type_menu === 'dashboard'? 'active' : ''  }}">
                <a class="nav-link active" href="{{ route('dashboard.index') }}"><i class="fas fa-fire"></i> <span>Dashboard</span></a>
            </li>
