                                ...
                                <ul class="nav nav-pills">
                                    <li class="nav-item">
                                        <a class="nav-link active"
                                            href="">Semua Perizinan <span class="badge badge-white">
                                                {{ $jumlah_data}}
                                                 </span></a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link"
                                            href="">Diproses <span class="badge badge-primary">
                                                {{-- {{ $jumlah_Perizinan_diproses}} --}}
                                                </span></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link"
                                            href="">Selesai <span class="badge badge-primary">
                                                {{-- {{ $jumlah_Perizinan_selesai}} --}}
                                                </span></a>
                                    </li>
                                </ul>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="table-links">
                                                    <a href="
                                                    {{-- {{ route('Perizinan.show', $k->id_Perizinan) }} --}}
                                                    ">View</a>
