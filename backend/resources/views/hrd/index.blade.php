            ...
            <div class="col-lg-8 col-md-12 col-12 col-sm-12">
                <div class="card pb-3">
                    ...
                    <div class="card-body">
                        <canvas id="myChart"
                            height="182"></canvas>
                        <input type="hidden" id="data-chart" data-label="{{ $data['statistik']['label_statistik'] }}" data-data="{{ $data['statistik']['data_statistik'] }}" />
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="list-unstyled list-unstyled-border">
                            @foreach($data['absensi_terbaru'] as $key => $ab)
                            <li class="media">
                                <img class="rounded-circle mr-3"
                                    width="50"
                                    src="{{ asset('img/avatar/avatar-'.($key+1).'.png') }}"
                                    alt="avatar">
                                <div class="media-body">
                                    <div class="text-primary float-right ml-3">{{ str_replace(' from now', '', \Carbon\Carbon::parse($ab->waktu_absensi)->addHours(7)->diffForHumans()) }}</div>
                                    <div class="media-title">{{ $ab->karyawan->nama }}</div>
                                    <span class="text-small text-muted">Telah melakukan absensi pada {{ $ab->waktu_absensi }}</span>
                                </div>
                            </li>
                            @endforeach
                            <!-- <li class="media">
                        ...
                        <div class="pt-1 pb-1 text-center">
                            <a href="{{ route('hrd_absensi.index') }}"
