...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/hrd_absensi/tanggal/{date}', [HRD_AbsensiController::class, 'tanggal'])->name('hrd_absensi.tanggal');
    ...
    Route::get('/karyawan/destroy/{id}', [HRD_karyawanController::class, 'destroy'])->name('karyawan.destroy');
